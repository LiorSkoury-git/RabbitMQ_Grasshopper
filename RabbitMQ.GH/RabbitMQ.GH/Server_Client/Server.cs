...
{
    /// <summary>
    /// Represents a RabbitMQ Server inheriting from the GH_component class.
    /// </summary>
    public class Server : GH_Component
    {
        #region Fields
        ...
        /// </summary>
        public Server(): base("Server", "Server", "A server rabbitMQ object", "RabbitMQ", "Server-Client")
        {
            counter = 0;
        ...
        {
            get { return new Guid("4DAFDE88-3E3C-4095-AFDF-EACBC8267EA8"); }
        }
